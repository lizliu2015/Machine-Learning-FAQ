...
![image](https://user-images.githubusercontent.com/13955626/161689982-8594dd38-52ca-4439-be0a-40ae92fc0146.png)
...
The duality theory provides a convenient way to deal with the constraints. The dual optimization problem can be written in terms of dot products(inner products, which measures some level of similarity), thereby making it possible to use kernel functions.
